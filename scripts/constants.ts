export const CONTRACTS: Record<string, string> = {
    guita: "GuitaERC20Token",
    sGuita: "sGuita",
    gGuita: "gGUITA",
    staking: "GuitaStaking",
    distributor: "Distributor",
    treasury: "GuitaTreasury",
    bondDepo: "GuitaBondDepository",
    teller: "BondTeller",
    bondingCalculator: "GuitaBondingCalculator",
    authority: "GuitaAuthority",
    migrator: "GuitaTokenMigrator",
    FRAX: "Frax",
    DAI: "DAI",
};
