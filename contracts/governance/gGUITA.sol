...
contract gGUITA is IgGUITA, ERC20 {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(address _migrator, address _sGUITA) ERC20("Governance GUITA", "gGUITA", 18) {
     ...
     * @param _sGUITA address
     */
    function migrate(address _staking, address _sGUITA) external override onlyApproved {
        ...
        require(_sGUITA != address(0), "Zero address found");
        sGUITA = IsGUITA(_sGUITA);
    }
    ...
    /**
     * @notice pull index from sGUITA token
     */
    ...
    /**
        @notice converts gGUITA amount to GUITA
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts GUITA amount to gGUITA
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gGUITA::getPriorVotes: not yet determined");
