...
contract BondTeller is ITeller, GuitaAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    struct Bond {
        ...
        uint256 payout; // sGUITA remaining to be paid. agnostic balance
    ...
    IERC20 internal immutable GUITA;
    IsGUITA internal immutable sGUITA; // payment token
    ...
    function newBond(
        ...
        GUITA.approve(address(staking), _payout);
    ...
    function getReward() external override {
        ...
        FERs[msg.sender] = 0;
        GUITA.safeTransfer(msg.sender, reward);
    }
    ...
    function pay(address _bonder, uint256 _amount) internal {
        sGUITA.safeTransfer(_bonder, _amount);
    }
    ...
    /**
     * @notice calculate amount of GUITA available for claim for single bond
     * @param _bonder address
    ...
    /**
     * @notice calculate amount of GUITA available for claim for array of bonds
     * @param _bonder address
        ...
        returns (uint256 pending_)
    {
        ...
        pending_ = sGUITA.fromG(pending_);
    }
